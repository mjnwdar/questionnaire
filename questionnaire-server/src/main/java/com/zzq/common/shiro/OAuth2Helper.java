package com.zzq.common.shiro;

import com.zzq.common.constants.AuthcTypeEnum;
import com.zzq.common.exception.AuthcTypeNotSupportException;
    ...
    public AuthRequest getAuthRequest(AuthcTypeEnum authcTypeEnum) {
        ...
        switch (authcTypeEnum) {
            ...
            case GITEE:
                ...
                break;
            default:
                throw new IllegalStateException("Unexpected value: " + authcTypeEnum);
        }
        return authRequest;
    }
