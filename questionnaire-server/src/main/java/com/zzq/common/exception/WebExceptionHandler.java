...
public class WebExceptionHandler {
    ...
    public String authcTypeNotSupport(AuthcTypeNotSupportException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR.value());
    }
    ...
    public String unauthorized(NoHandlerFoundException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "请求的地址不存在", HttpStatus.NOT_FOUND.value());
    }
    ...
    public String unauthorized(Exception e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "无权限");
    }
    ...
    public String unknownAccount(UnknownAccountException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "账号不存在");
    }
    ...
    public String incorrectCredentials(IncorrectCredentialsException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "密码错误");
    }
    ...
    public String excessiveAttemptsException(ExcessiveAttemptsException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "登录失败次数过多, 请稍后再试");
    }
    ...
    public String lockedAccount(LockedAccountException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "账号已锁定");
    }
    ...
    public String lockedAccount(CaptchaIncorrectException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "验证码错误");
    }
    ...
    public String lockedAccount(DuplicateNameException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "用户名已存在");
    }
    ...
    public String missingRequestParameter(MissingServletRequestParameterException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, "请求参数缺失");
    }
    ...
    public String methodArgumentNotValid(BindException e) {
        ...
        return generateErrorInfo(ResultEntity.FAIL, errorMessage.toString());
    }
    ...
    public String all(Exception e) {
        ...
        log.error(msg, e);
        generateErrorInfo(ResultEntity.FAIL, msg, HttpStatus.INTERNAL_SERVER_ERROR.value());
